...
<body>
<div id="container">
    <div class="container_head"><h2>欢迎学生登录&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="container_display">
        <div class="container_display_left">
          <ul>
             <li><a href="PersonalAction?sid=<%=session.getValue("sid") %>" target="displayinfo">个人信息</a></li>
             <li><a href="SelectOpenDirectionAction?sid=<%=request.getParameter("sid") %>" target="displayinfo">选择方向</a></li>        
          </ul>
        </div>
